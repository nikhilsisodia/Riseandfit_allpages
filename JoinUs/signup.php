    ...
    if (isset($_POST['submit'])) {
        ...
        if ($emailcount > 0) {
            ...
            if ($password === $cpassword) {
                ...
                $insertquery = "INSERT INTO `registration` ( `name`, `email`, `mobile`, `password`, `token`, `status`) VALUES ( '$username', '$email', '$phone', '$pass','$token','inactive')";
                ...
                if ($result) {
                    ...
                    http://riseandfit.com/JoinUs/activate.php?token=$token ";
        ...
        <div class="content">
            ...
            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <div class="field space">
                    ...
                    <input type="password" name="password" class="pass-key" id="password" required
                        placeholder="Create Password">
                    <span class="formShow" id="show1">SHOW</span>
                </div>

                <div class="field space">
                    <span class="fa fa-lock"></span>
                    <input type="password" name="cpassword" class="pass-key" id="cpassword" required
                        placeholder="Confirm Password">
                    <span class="formShow" id="show2">SHOW</span>
                </div>
            ...
            <div class="row">
                <div class="col-md-3 footer1 d-flex wow bounceInLeft" data-wow-delay=".25s">
                    <div class="d-flex flex-wrap align-content-center">
                        <a href="#"><img src="./image/raflogo.jpg" alt="logo" /></a>
                        <p>
                            Let's take a step, invest your time and energy, yourself for the
                            good of you and your family. Come join the way to a healthy
                            life. Weaving fitness into your busy lifestyle!
                        </p>
                        <p>
                            &copy;All rights reserved.<br />
                            Designed by
                            <a href="http://riseandfit.com/" target="_blank">Rise and Fit</a>.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 footer2 wow bounceInUp" data-wow-delay=".25s" id="contact">
                    <div class="form-box">
                        ...
                        <table class="table table-responsive d-table">
                            <tr>
                                <td>
                                    <input type="text" class="form-control pl-0" placeholder="NAME" />
                                </td>
                                <td>
                                    <input type="email" class="form-control pl-0" placeholder="EMAIL" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <input type="text" class="form-control pl-0" placeholder="ADDRESS" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <input type="text" class="form-control pl-0" placeholder="MESSAGES" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                ...
                <div class="col-md-3 footer3 wow bounceInRight" data-wow-delay=".25s">
                    <h5>ADDRESS</h5>
                    <p>
                        Couple Park Rajpath Area, Raisina Hills, New Delhi, Delhi 110011.
                    </p>
                    <h5>PHONE</h5>
                    <p>9068179706</p>
                    <h5>EMAIL</h5>
                    ...
                    <div class="social-links">
                        <ul class="sci">
                            <li>
                                <a href="https://www.facebook.com/Riseandfit"><img style="margin-bottom: 8px"
                                        src="./image/facebook.png" alt="facebook" /></a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/riseandfitt/"
                                    class="btn btn-secondary mr-1 ml-1 mb-2"><img style="margin-bottom: 8px"
                                        src="./image/instalogo.png" alt="Instagram" /></a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/company/riseandfit"
                                    class="btn btn-secondary mr-1 ml-1 mb-2"><img style="margin-bottom: 8px"
                                        src="./image/linkedinlogo.png" alt="linkedin" /></a>
                            </li>
                        </ul>
                    </div>
                </div>
